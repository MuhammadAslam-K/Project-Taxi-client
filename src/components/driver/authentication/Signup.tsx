...
function SignUp() {
    ...
    const submitSignUpForm = async () => {
        try {
            await driverAxios.post(driverApis.signup, formik.values)
            navigate(driverEndpoints.login)
        } catch (error) {
            console.log("Error in driver signup", error)
        }
    }
                    ...
                    <div className="w-full ">
                        <div className="p-8">
                            ...
                            <div className="mt-2 text-center">
                                <p className="text-sm text-gray-600">Already have an account? <Link to={driverEndpoints.login} className="font-bold text-blue-600 no-underline hover:text-blue-400">Sign in</Link></p>
                            </div>
                        </div>
                    </div>
                </div>
